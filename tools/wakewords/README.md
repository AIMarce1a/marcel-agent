...
`hey_marcel.onnx` / `hey_marcel.tflite` — the on-device "Hey Marcel" hotword
...
- **Label:** the model registers as `hey_marcel` (matches the filename).
