...
LOCAL_STT_COMMAND_ENV = "MARCEL_LOCAL_STT_COMMAND"
LOCAL_STT_LANGUAGE_ENV = "MARCEL_LOCAL_STT_LANGUAGE"
...
# DeepInfra STT base URL is resolved via marcel_cli.models.deepinfra_base_url (shared).
