...
Used by marcel_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
_skills_dir = _path_resolver("SKILLS_DIR", "MARCEL_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"MARCEL_HOME": _marcel_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'MARCEL_INDEX_TTL': ('tools.skills_hub_search', 'MARCEL_INDEX_TTL'),
    'MARCEL_INDEX_URL': ('tools.skills_hub_search', 'MARCEL_INDEX_URL'),
    'MarcelIndexSource': ('tools.skills_hub_official', 'MarcelIndexSource'),
