...
DIALOG_BRIDGE_HOST = "marcel-dialog-bridge.invalid"
...
(() => {
  if (window.__marcelDialogBridgeInstalled) return;
  window.__marcelDialogBridgeInstalled = true;
  const ENDPOINT = "http://marcel-dialog-bridge.invalid/";
