...
# containing `cat ~/.marcel/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `marcel-agent-dev` skill contains a security postmortem mentioning `cat ~/.marcel/.env`, which tripped
