...
/api/fs. Logic lives in ``marcel_cli.web_git``; these are thin executor-offloaded
...
from marcel_cli import web_git as _web_git
from marcel_cli.web_deps import late
from marcel_cli.web_server_files import _fs_path
