"""Marcel middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "marcel.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "marcel.middleware.v1"
...
def _apply_request_chain(
    ...
    from marcel_cli.plugins import invoke_middleware
...
def apply_llm_request_middleware(request: Dict[str, Any], **context: Any) -> RequestMiddlewareResult:
    ...
    from marcel_cli.plugins import has_middleware
