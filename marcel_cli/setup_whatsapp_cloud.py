...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Marcel to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Marcel needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Marcel gateway in another terminal:",
        "         marcel gateway", "",
