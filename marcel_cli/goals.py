"""Persistent session goals — the Ralph loop for Marcel.
...
# (schema DDL, FTS tables, first marcel_cli.config import) measures ~300ms warm and more on slow
...
def _get_session_db() -> Optional[Any]:
    """Cached SessionDB per MARCEL_HOME (profile switches pick the right DB); None on any failure.
