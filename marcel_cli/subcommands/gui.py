...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the Marcel Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any marcel CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--marcel-root",
        help="Override the Marcel source root used by Desktop (sets MARCEL_DESKTOP_MARCEL_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets MARCEL_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="Marcel Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Marcel Local Signing)",
    )
