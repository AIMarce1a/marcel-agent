"""``marcel uninstall`` subcommand parser."""
...
def build_uninstall_parser(subparsers, *, cmd_uninstall: Callable) -> None:
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall", help="Uninstall Marcel Agent",
        description="Remove Marcel Agent from your system. Can keep configs/data for reinstall.")
