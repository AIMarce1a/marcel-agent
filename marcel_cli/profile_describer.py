...
Mirrors ``marcel_cli/kanban_specify.py``: lazy aux client import, lenient response parse,
...
_SYSTEM_PROMPT = """You are a profile-describer for the Marcel Agent kanban board.
...
Rules:
  ...
  - Never write "Marcel Agent profile" or other meta-narration.
...
def _extract_json_blob(raw: str) -> Optional[dict]:
    from marcel_cli.kanban_specify import _extract_json_blob as _extract
