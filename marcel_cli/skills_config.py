"""Skills configuration for Marcel Agent. `marcel skills` enters this module."""
from typing import List, Optional, Set

from marcel_cli.config import cfg_get, load_config, save_config
from marcel_cli.colors import Colors, color
from marcel_cli.platforms import PLATFORMS as _PLATFORMS
...
def save_disabled_skills(config: dict, disabled: Set[str], platform: Optional[str] = None):
    """Persist disabled skill names to config; essential skills (e.g. ``marcel-agent``) are
