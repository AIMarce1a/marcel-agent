...
from marcel_cli.dashboard_auth import list_session_providers
...
from marcel_cli.dashboard_auth.prefix import prefix_from_request
from marcel_cli.dashboard_auth.public_paths import PUBLIC_API_PATHS
from marcel_cli.dashboard_auth.request_utils import (
...
def _safe_next_target(request: Request) -> str:
    ...
    SPA's ``sessionStorage["marcel.lastLocation"]``."""
...
_PLUGIN_COMPAT_LAZY = {
    'DashboardAuthProvider': ('marcel_cli.dashboard_auth.base', 'DashboardAuthProvider'),
}
