...
<title>Sign in — Marcel Agent</title>
<style>
...
<main>
  ...
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Marcel Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Marcel Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
