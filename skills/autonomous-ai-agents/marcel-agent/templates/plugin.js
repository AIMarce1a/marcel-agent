/**
 * Marcel desktop plugin template. Save as:
 *   <marcel home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <marcel home> is ~/.marcel by default, or ~/.marcel/profiles/<name>
 * when running a named profile (`marcel -p <name>`). Run `marcel doctor` (or
 ...
 * Only these imports resolve: @marcel/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@marcel/plugin-sdk'
