...
Registry of record: `marcel_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Marcel config+state snapshots (CLI)
...
/update                  Update Marcel to latest
