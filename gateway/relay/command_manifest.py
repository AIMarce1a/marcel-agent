...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Marcel session"),
        ...
        _cmd("status", "Show Marcel session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Marcel agent"),
        ...
        _cmd("update", "Update Marcel Agent to the latest version"),
        _cmd("restart", "Gracefully restart the Marcel gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Marcel session in it",
