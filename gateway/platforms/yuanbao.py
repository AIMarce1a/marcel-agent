...
from gateway.platforms.yuanbao_proto import (
    CMD_TYPE, WS_HEARTBEAT_RUNNING, WS_HEARTBEAT_FINISH, MARCEL_INSTANCE_ID,
...
_APP_VERSION = _BOT_VERSION = _MARCEL_VERSION
_YUANBAO_INSTANCE_ID = str(MARCEL_INSTANCE_ID)
