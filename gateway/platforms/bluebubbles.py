...
# `require_mention: true` without custom aliases uses Marcel wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?marcel\s+agent\b[,:\-]?", r"(?<![\w@])@?marcel\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (Marcel defaults)."""
