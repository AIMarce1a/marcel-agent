 ...
 *
 * Each entry is a key/value pair that lands in the packaged Marcel.app's
 ...
 * "Marcel wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Marcel wants to access Music" when Marcel never touches the Music
