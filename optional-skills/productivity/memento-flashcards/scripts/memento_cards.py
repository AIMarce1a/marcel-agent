...
Data file: $MARCEL_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_MARCEL_HOME = Path(os.environ.get("MARCEL_HOME", Path.home() / ".marcel"))
DATA_DIR = _MARCEL_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
