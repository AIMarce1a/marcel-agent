...
def _state_dir() -> Path:
    ...
    # Default: $MARCEL_HOME/watcher-state/, falling back to ~/.marcel/watcher-state/.
    marcel_home = os.environ.get("MARCEL_HOME") or str(Path.home() / ".marcel")
    return Path(marcel_home) / "watcher-state"
