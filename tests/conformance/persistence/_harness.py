...
def make_marcel_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated MARCEL_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"marcel-home-{journal_mode}"
