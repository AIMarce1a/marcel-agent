"""Regression test: marcel update must not load cryptography eagerly."""
...
assert 'marcel_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running marcel update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so marcel_cli is importable,
