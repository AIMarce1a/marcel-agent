...
def _isolate_env(tmp_path, monkeypatch):
    """Ensure MARCEL_HOME and RETAINDB vars are isolated."""
...
class TestRetainDBMemoryProvider:
    ...
    def test_initialize_creates_client_and_queue(self, tmp_path, monkeypatch):
        ...
        p.initialize("test-session", marcel_home=str(tmp_path / ".marcel"))
...
class TestPrefetch:
    ...
    def _make_initialized_provider(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("MARCEL_HOME", str(marcel_home))
        p = RetainDBMemoryProvider()
        p.initialize("test-session", marcel_home=str(marcel_home))
        return p
