...
``marcel_cli.web_server_sessions._open_session_db_at_path``. These tests pin the
...
from marcel_state_common import DEFERRED_INDEX_SQL, SCHEMA_SQL
from marcel_state_schema import SessionSchemaMixin, schema_read_probe_statements
