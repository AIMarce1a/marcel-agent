"""Session <-> workspace grouping key (marcel_state_sessions.workspace_key).

The key is what `marcel sessions list --workspace` groups/filters on. It is a
...
import marcel_state_sessions
from marcel_state_sessions import workspace_key
