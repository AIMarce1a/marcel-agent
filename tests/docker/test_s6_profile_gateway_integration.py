...
The unit tests in tests/marcel_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned marcel-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/marcel")
from marcel_cli.service_manager import S6ServiceManager
