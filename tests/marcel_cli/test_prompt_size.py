"""Tests for the ``marcel prompt-size`` diagnostic (issue #34667)."""
...
from marcel_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(marcel_home, memory_text="", user_text=""):
    mem_dir = marcel_home / "memories"
...
def _seed_skill(marcel_home, name, description):
    skill_dir = marcel_home / "skills" / "demo" / name
