"""Tests for `marcel curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated MARCEL_HOME with real agent-created skills on disk."""
    ...
    from marcel_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import marcel_cli.curator as curator_cli
