"""Tests for the shared byte formatter (marcel_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from marcel_cli.backup import _format_size as backup
    from marcel_cli.checkpoints import _fmt_bytes as checkpoints
    from marcel_cli.sizefmt import format_bytes as doctor
