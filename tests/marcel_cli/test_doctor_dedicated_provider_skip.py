"""Regression: marcel doctor must not run a generic Bearer-auth health
...
with HTTP 404. The dedicated check at marcel_cli/doctor.py already covers
...
from marcel_cli import doctor_connectivity


def test_build_apikey_providers_list_skips_dedicated_check_providers():
    from marcel_cli import doctor
