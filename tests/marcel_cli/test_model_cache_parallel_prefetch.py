...
import pytest
from marcel_cli import model_switch_providers


# ---------------------------------------------------------------------------
# Thread-safe cache entry update (marcel_cli/models.py)
# ---------------------------------------------------------------------------
...
class TestUpdateProviderCacheEntry:
    ...
    def test_writes_new_entry(self, tmp_path, monkeypatch):
        ...
        import marcel_cli.models as mod
...
# ---------------------------------------------------------------------------
# Parallel prefetch (marcel_cli/model_switch.py)
# ---------------------------------------------------------------------------
...
class TestPrefetchProviderModelsParallel:
    ...
    def test_skips_all_fresh_entries(self, monkeypatch):
        ...
        from marcel_cli.model_switch_providers import _prefetch_provider_models_parallel
        ...
        with patch("marcel_cli.models._load_provider_models_cache", return_value=fresh_cache), \
             patch("marcel_cli.models._credential_fingerprint", return_value="fp"), \
             patch("marcel_cli.models.cached_provider_model_ids") as fetch:
    ...
    def test_fetches_only_stale_entries(self, monkeypatch):
        ...
        with patch("marcel_cli.models._load_provider_models_cache", return_value=cache), \
             patch("marcel_cli.models._credential_fingerprint", return_value="fp_f"), \
             patch("marcel_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("marcel_cli.models.update_provider_cache_entry"):
    ...
    def test_fetches_in_parallel(self, monkeypatch):
        ...
        with patch("marcel_cli.models._load_provider_models_cache", return_value={}), \
             patch("marcel_cli.models._credential_fingerprint", return_value="fp"), \
             patch("marcel_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("marcel_cli.models.update_provider_cache_entry"):
    ...
    def test_empty_list_is_noop(self):
        ...
        with patch("marcel_cli.models.cached_provider_model_ids") as fetch:
