"""Fetch-failure classification for `marcel update` / `marcel update --check`.
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `marcel update` sit on
    ...
    from marcel_cli import update_cmd_git
