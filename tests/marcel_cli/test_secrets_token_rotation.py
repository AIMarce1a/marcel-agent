"""Tests for `marcel secrets bitwarden token` / `marcel secrets onepassword token`.
...
from marcel_cli import onepassword_secrets_cli as op_cli
from marcel_cli import secrets_cli as bw_cli
