...
from marcel_cli.local_runtime.catalog import (
    CATALOG,
    catalog_by_id,
...
def test_hybrid_long_context_stays_cheap():
    ...
    from marcel_cli.local_runtime.catalog import FLOOR
    from marcel_cli.local_runtime.estimator import ctx_bytes
