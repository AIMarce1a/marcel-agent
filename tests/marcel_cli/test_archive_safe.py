"""Tests for the shared tar.gz writer (``marcel_cli.archive_safe.make_targz``).

``make_targz`` backs both ``marcel profile export`` and ``marcel kanban
...
from marcel_cli.archive_safe import make_targz
