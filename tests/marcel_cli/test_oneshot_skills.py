...
The oneshot path builds its AIAgent directly (bypassing MarcelCLI), so the
...
from marcel_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
