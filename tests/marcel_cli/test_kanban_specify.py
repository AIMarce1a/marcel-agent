"""Tests for the specifier module + `marcel kanban specify` CLI surface.
...
from marcel_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `marcel kanban …` argparse surface directly."""
