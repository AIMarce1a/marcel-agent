...
Run before any catalog commit:
    ...
    MARCEL_TEST_NETWORK=1 scripts/run_tests.sh tests/marcel_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("MARCEL_TEST_NETWORK"),
    reason="network test; set MARCEL_TEST_NETWORK=1 to run",
)
