"""Tests for the interactive session browser (`marcel sessions browse`).
...
from marcel_cli.sessions_cmd_browse import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """marcel sessions browse should be parseable."""
