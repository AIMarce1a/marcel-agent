"""Tests for `marcel chat --safe-mode` isolation."""
...
_VARS = ("MARCEL_SAFE_MODE", "MARCEL_IGNORE_USER_CONFIG", "MARCEL_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["MARCEL_SAFE_MODE"] == "1"
        assert os.environ["MARCEL_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["MARCEL_IGNORE_RULES"] == "1"
        return True
