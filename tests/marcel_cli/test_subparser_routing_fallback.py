...
The main() function in marcel_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `marcel -c model`
...
def _build_parser():
    """Build a minimal replica of the marcel top-level parser."""
