...
import marcel_cli.mcp_startup as mcp_startup
import marcel_cli.web_server as web_server
import marcel_cli.web_server_lifecycle as web_server_lifecycle
from tests.marcel_cli.test_dashboard_auth_gate import _stub_uvicorn_run
