...
import marcel_cli.model_switch_providers as marcel_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(marcel_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("marcel_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import marcel_cli.models as hm
    import marcel_cli.models_catalog_static as marcel_cli_models_catalog_static
    from marcel_cli import models_catalog_static
    ...
    monkeypatch.setattr(marcel_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
