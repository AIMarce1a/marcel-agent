"""Tests for `_can_open_graphical_browser()` in marcel_cli.auth.

Guards the fix for the May 2026 report where `marcel auth add xai-oauth`
...
from marcel_cli.auth import _can_open_graphical_browser
