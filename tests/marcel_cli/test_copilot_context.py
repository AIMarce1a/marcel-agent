...
class TestGetCopilotModelContext:
    ...
    @patch("marcel_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("marcel_cli.models._urlopen_model_catalog_request")
    ...
    @patch("marcel_cli.models.fetch_github_model_catalog", return_value=[])
