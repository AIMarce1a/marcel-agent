"""Tests for ``marcel approvals suggest`` (marcel_cli/approvals_suggest.py).

Approval history in Marcel is implied, not ledgered: the session DB
...
from marcel_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
