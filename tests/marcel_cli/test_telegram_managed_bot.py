"""Tests for marcel_cli.telegram_managed_bot — QR codes, deep links, pairing."""
...
class TestCreatePairing:
    def test_success(self):
        ...
        mock_resp.json.return_value = {
            ...
            "suggested_username": "marcel_abcdefghijklmnop_bot",
            "deep_link": "https://t.me/newbot/MarcelSetupBot/marcel_abcdefghijklmnop_bot?name=Marcel+Agent",
            "qr_payload": "https://t.me/newbot/MarcelSetupBot/marcel_abcdefghijklmnop_bot?name=Marcel+Agent",
            "expires_at": "2026-05-18T00:00:00.000Z",
        }

        with patch(
            "marcel_cli.telegram_managed_bot.httpx.post", return_value=mock_resp
        ) as post:
            pairing = create_pairing("https://api.example.com", bot_name="Marcel Agent")
...
class TestPollForToken:
    def pairing(self):
        return TelegramPairing(
            ...
            poll_token="secret-token",
            suggested_username="marcel_abcdefghijklmnop_bot",
            deep_link="https://t.me/newbot/MarcelSetupBot/marcel_abcdefghijklmnop_bot",
            qr_payload="https://t.me/newbot/MarcelSetupBot/marcel_abcdefghijklmnop_bot",
        )
    ...
    def test_immediate_success(self):
        ...
        mock_resp.json.return_value = {
            "bot_username": "marcel_abcdefghijklmnop_bot",
            "owner_user_id": 42,
            "status": "ready",
            "token": VALID_TOKEN,
        }
        ...
        with patch(
            "marcel_cli.telegram_managed_bot.httpx.get", return_value=mock_resp
        ) as get:
            with patch("marcel_cli.telegram_managed_bot.time.sleep"):
    ...
    def test_eventual_success(self):
        ...
        with patch("marcel_cli.telegram_managed_bot.httpx.get", side_effect=fake_get):
            with patch("marcel_cli.telegram_managed_bot.time.sleep"):
                result = poll_for_setup_result(
...
class TestSetupTelegramAuto:
    def test_setup_result_passes_profile_name_for_profile_home(self, monkeypatch, tmp_path):
        ...
        seen = {}
        profile_home = tmp_path / ".marcel" / "profiles" / "oracle"
        profile_home.mkdir(parents=True)

        monkeypatch.setattr(setup, "get_marcel_home", lambda: profile_home)
        ...
        monkeypatch.setattr(
            "marcel_cli.telegram_managed_bot.auto_setup_telegram_bot_result",
    ...
    def test_profile_name_from_home_path_handles_windows_separators(self):
        from marcel_cli.setup_platforms import _profile_name_from_marcel_home

        assert (
            _profile_name_from_marcel_home(
                PureWindowsPath(r"C:\Users\test\AppData\Local\marcel\profiles\oracle")
            )
            == "oracle"
        )
