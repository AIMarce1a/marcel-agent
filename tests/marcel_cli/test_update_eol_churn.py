"""Regression: ``marcel update`` should take a managed checkout off autocrlf=true.
...
``marcel update`` has to repair them.
...
from marcel_cli.update_cmd import _normalize_managed_eol
