...
Profile-aware location: ``$MARCEL_HOME/logs/dashboard-auth.log``.
...
from marcel_cli.dashboard_auth.audit import audit_log, AuditEvent


@pytest.fixture
def profile_home(tmp_path, monkeypatch):
    """Redirect $MARCEL_HOME and ~ to a tmp dir for the duration of the test."""
