...
import marcel_cli.macos_tcc_anchor as tcc
...
class TestUvStoreDetection:
    ...
    def test_matches_marcel_runtime_repair_generation(self):
        path = (
            "/Users/u/marcel-agent/.marcel-runtime/python/"
...
class TestEnsureTccAnchor:
    ...
    def test_store_root_marker_tracks_managed_uv_constant(self):
        ...
        from marcel_cli.managed_uv import _RUNTIME_DIR_NAME
