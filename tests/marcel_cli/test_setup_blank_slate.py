"""Tests for Blank Slate setup mode (marcel_cli/setup.py).
...
from marcel_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
