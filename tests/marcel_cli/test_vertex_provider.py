...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (marcel_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_marcel_overlays():
    """marcel_cli.providers.get_provider("vertex") backs
