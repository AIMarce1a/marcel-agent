...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and marcel-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # marcel-agent (tests/skills/)
]
