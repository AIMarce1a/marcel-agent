"""The `marcel-agent` skill is what a running Marcel knows about itself.

`website/` is never packaged, so an installed Marcel has no local copy of the
user guide; skills ARE synced into `$MARCEL_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Marcel can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "marcel-agent"
