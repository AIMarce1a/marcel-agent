...
def test_chat_gateway_applies_marcel_branding(monkeypatch):
    monkeypatch.setenv("MARCEL_BRANDING", "1")
    raw = "Configure ~/.marcel/.env with marcel setup. Marcel will then restart."
