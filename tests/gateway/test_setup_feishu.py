"""Tests for _setup_feishu() in marcel_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("marcel_cli.config.save_env_value", side_effect=mock_save), \
         patch("marcel_cli.config.get_env_value", side_effect=mock_get), \
         patch("marcel_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("marcel_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("marcel_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("marcel_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("marcel_cli.cli_output.print_header"), \
         patch("marcel_cli.cli_output.print_info"), \
         patch("marcel_cli.cli_output.print_success"), \
         patch("marcel_cli.cli_output.print_warning"), \
         patch("marcel_cli.cli_output.print_error"), \
