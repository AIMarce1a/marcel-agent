...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.marcel/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at marcel_state import time, before pytest's MARCEL_HOME monkeypatch
    fires — the autouse fixture's MARCEL_HOME override doesn't help here.)
    """
    import marcel_state
