...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("MARCEL_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("MARCEL_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("MARCEL_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
