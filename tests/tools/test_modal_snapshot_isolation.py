...
def _restore_tool_modules():
    original_marcel_home = os.environ.get("MARCEL_HOME")
    original_modules = {
        name: module
    ...
    try:
        ...
        if original_marcel_home is None:
            os.environ.pop("MARCEL_HOME", None)
        else:
            os.environ["MARCEL_HOME"] = original_marcel_home
        _reset_modules(("tools", "marcel_cli", "modal"))
...
def _install_modal_test_modules(
    ...
    *,
    ...
    marcel_cli = types.ModuleType("marcel_cli")
    marcel_cli.__path__ = []  # type: ignore[attr-defined]
    sys.modules["marcel_cli"] = marcel_cli
    marcel_home = tmp_path / "marcel-home"
    os.environ["MARCEL_HOME"] = str(marcel_home)
    sys.modules["marcel_cli.config"] = types.SimpleNamespace(
        get_marcel_home=lambda: marcel_home,
    )
    ...
    async def _lookup_aio(_name: str, create_if_missing: bool = False):
        return types.SimpleNamespace(name="marcel-agent", create_if_missing=create_if_missing)
    ...
    return {
        "snapshot_store": marcel_home / "modal_snapshots.json",
