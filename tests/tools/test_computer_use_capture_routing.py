...
* ``marcel_constants.get_marcel_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_marcel_dir so cache writes land under tmp_path."""
    ...
    with patch("marcel_constants.get_marcel_dir", _fake_get):
        yield cache_dir
