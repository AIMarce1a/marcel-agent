...
def _make_backend(session: _FakeSession):
    ...
    backend._session_id = "marcel-session"
...
def test_backends_are_isolated_by_marcel_session_and_reused_within_it():
...
def test_concurrent_marcel_sessions_do_not_share_backend_state():
    from tools.computer_use import tool as computer_use
