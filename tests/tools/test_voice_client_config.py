...
Real config files in a temp MARCEL_HOME, real resolution chains (no mocked
...
def voice_home(tmp_path, monkeypatch):
    """Isolated MARCEL_HOME + reloaded config modules; yields a config writer."""
    ...
    for var in (
        ...
        "DEEPINFRA_API_KEY", "MARCEL_LOCAL_STT_LANGUAGE",
    ):
