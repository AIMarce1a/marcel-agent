...
thinking phase.  Marcel's default cloud-stream stale detector
(``MARCEL_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``MARCEL_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
