...
CA bundle env vars (MARCEL_CA_BUNDLE, REQUESTS_CA_BUNDLE, SSL_CERT_FILE)
...
_CA_ENV_VARS = ("MARCEL_CA_BUNDLE", "REQUESTS_CA_BUNDLE", "SSL_CERT_FILE")
...
class TestResolveRequestsVerify:
    ...
    def test_priority_marcel_over_requests(self, clean_env, tmp_path, bundle_file):
