...
manipulation. Marcel keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point MARCEL_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_marcel_home /
    get_default_marcel_root) instead of monkeypatching private helpers —
    ...
    MARCEL_HOME=<root>/profiles/<name> makes get_default_marcel_root()
