...
COMMON_MARCEL_TOOLS = ["read_file", "search_files", "terminal", "patch", "write_file", "process"]


class TestToolKindMap:
    def test_all_marcel_tools_have_kind(self):
        """Every common marcel tool should appear in TOOL_KIND_MAP."""
        for tool in COMMON_MARCEL_TOOLS:
...
class TestBuildToolTitle:
    ...
    def test_execute_code_title_includes_first_code_line(self):
        ...
        assert title == "python: from marcel_tools import terminal"
