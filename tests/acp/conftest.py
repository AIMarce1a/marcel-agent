...
Keeps the ACP server tests offline: ``MarcelACPAgent._build_model_state``
calls ``marcel_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import marcel_cli.inventory as inventory
