...
from acp_adapter.server import MarcelACPAgent
...
class TestNamedCustomProviderCatalogs:
    ...
    def test_live_discovery_extends_declared_models(self, monkeypatch):
        ...
        with patch("marcel_cli.config.load_config", return_value=cfg), patch(
            "marcel_cli.model_switch_providers._fetch_picker_live_models",
    ...
    def test_disabled_provider_skipped(self, monkeypatch):
        ...
        with patch("marcel_cli.config.load_config", return_value=cfg), patch(
            "marcel_cli.model_switch_providers._fetch_picker_live_models", return_value=None
        ):
    ...
    def test_native_empty_catalog_is_authoritative_over_default_model(self):
        ...
        from marcel_cli.model_switch_providers import _NativePickerModelList
...
class TestModelStateIncludesNamedProviders:
    ...
    def test_selector_choice_id_round_trips_through_parse_model_input(self):
        ...
        from marcel_cli.models import parse_model_input
