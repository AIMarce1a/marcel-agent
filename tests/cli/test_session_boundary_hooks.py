...
from marcel_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/marcel_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("marcel_cli.lifecycle.invoke_hook")
@patch("marcel_cli.lifecycle.finalize_session")
