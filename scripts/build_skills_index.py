#!/usr/bin/env python3
"""Build the Marcel Skills Index — a centralized JSON catalog of all skills.
...
`marcel skills search/install` can use it without hitting the GitHub API.
...
# Ensure MARCEL_HOME is set (needed by tools/skills_hub*.py imports)
...
def main():
    print("Building Marcel Skills Index...", flush=True)
