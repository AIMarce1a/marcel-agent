...
def main() -> None:
    ...
    marcel_home = Path(tempfile.mkdtemp(prefix="marcel-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "marcel-gateway-smoke",
    ...
    print(json.dumps({"marcel_home": str(marcel_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
