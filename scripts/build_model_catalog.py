#!/usr/bin/env python3
"""Build the Marcel Model Catalog — a centralized JSON manifest of curated models.
...
Marcel CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Marcel release.
...
# Ensure MARCEL_HOME is set for imports that touch it at module level.
os.environ.setdefault("MARCEL_HOME", os.path.join(os.path.expanduser("~"), ".marcel"))

from marcel_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
            ...
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Marcel '
