...
$RepoUrlSsh = "git@github.com:AIMarce1a/marcel-agent.git"
$RepoUrlHttps = "https://github.com/AIMarce1a/marcel-agent.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/AIMarce1a/marcel-agent/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/AIMarce1a/marcel-agent/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/AIMarce1a/marcel-agent/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
