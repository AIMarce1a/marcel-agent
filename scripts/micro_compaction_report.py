#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Marcel logs.
...
With no LOGFILE, reads ``$MARCEL_HOME/logs/agent.log`` (default ~/.marcel).
...
def default_log() -> Path:
    home = os.environ.get("MARCEL_HOME") or str(Path.home() / ".marcel")
