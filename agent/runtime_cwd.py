...
_SESSION_CWD: ContextVar = ContextVar("MARCEL_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the Marcel source tree, a
    legitimate workspace when developing Marcel; fallback-directory policy lives in the caller."""
