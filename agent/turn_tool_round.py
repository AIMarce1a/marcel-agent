...
def run_tool_round(
    ...
    Marcel; a failed canonical append ends the turn rather than running tools from
    process-only state."""
    ...
    # block if a destructive tool restarts Marcel.
    try:
    ...
    # the gateway inactivity timeout (MARCEL_AGENT_TIMEOUT).
    ...
    # follow-up API call can exceed the gateway inactivity timeout (MARCEL_AGENT_TIMEOUT, default 1800s) and
