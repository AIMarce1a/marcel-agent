...
A Marcel process may itself be a Kanban dispatcher worker with MARCEL_KANBAN_* in
...
_DELEGATED_CHILD_CONTEXT: ContextVar[bool] = ContextVar("marcel_delegated_child_context", default=False)
...
_NON_DISPATCHER_OWNED_CONTEXT: ContextVar[bool] = ContextVar("marcel_non_dispatcher_owned_context", default=False)

DELEGATED_CHILD_ENV_MARKER = "MARCEL_DELEGATED_CHILD_CONTEXT"

KANBAN_ENV_KEYS: tuple[str, ...] = (
    "MARCEL_KANBAN_TASK", "MARCEL_KANBAN_RUN_ID", "MARCEL_KANBAN_WORKSPACE", "MARCEL_KANBAN_WORKSPACES_ROOT",
    "MARCEL_KANBAN_CLAIM_LOCK", "MARCEL_KANBAN_BOARD", "MARCEL_KANBAN_DB",
)
...
def is_dispatcher_owned_worker_context() -> bool:
    """The single predicate every ``MARCEL_KANBAN_*`` identity gate should use."""
