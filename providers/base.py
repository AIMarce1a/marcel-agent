...
def _profile_user_agent() -> str:
    """Return a ``marcel-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from marcel_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"marcel-cli/{_ver}"
    except Exception:
        return "marcel-cli"
...
class ProviderProfile:
    ...
    # describe how to launch it; marcel_cli/auth.py's
    ...
    def create_client(self, **client_kwargs: Any) -> Any | None:
        ...
        a profile registered from ``~/.marcel/plugins/model-providers/`` or a
    ...
    def fetch_models(
        ...
        *,
        ...
        # marcel-cli UA so the catalog endpoint is reachable.
