# nix/overlays.nix — Expose pkgs.marcel-agent for external NixOS configs
#
...
# `pkgs.marcel-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    marcel-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
