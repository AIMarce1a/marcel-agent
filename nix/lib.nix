      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via MARCEL_BUNDLED_SKILLS /
            # MARCEL_OPTIONAL_SKILLS (see marcel-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + MARCEL_BUNDLED_LOCALES
            # / MARCEL_OPTIONAL_MCPS, not via the wheel. Excluding them
