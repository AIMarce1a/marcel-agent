...
benchmarked ten harnesses on hostile-file handling — and whose Marcel column
...
Every task runs the full Marcel agent (file + terminal + search toolsets)
...
Rules of engagement (from marcelbench discipline):
