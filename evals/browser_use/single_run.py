...
The run gets a throwaway MARCEL_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE MARCEL_HOME is redirected to the
