import { Box, type ScrollBoxHandle, stringWidth, Text } from '@marcel/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (MARCEL_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (MARCEL_DEV_CREDITS), lowest priority,
