 ...
 *
 * Symptom: in `marcel --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@marcel/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using marcel --tui and as i type multiline my caret at the end will often ' +
