import type { BillingBlock, UsageModelData } from '@marcel/shared/billing'
import type { MarcelSkin } from '@marcel/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@marcel/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = MarcelSkin
...
// Wire shapes now live in @marcel/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
