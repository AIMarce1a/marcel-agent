...
import type { ScrollBoxHandle } from '@marcel/ink'
import { evictInkCaches } from '@marcel/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.MARCEL_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
