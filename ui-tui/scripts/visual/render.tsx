 ...
 * across theme x background scenes to <tmpdir>/marcel-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@marcel/ink'
...
// The regenerated slate light_colors block from marcel_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/marcel-agent',
...
const setup = (bgHex: string) => {
  process.env.MARCEL_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
