...
await build({
  ...
  // Skip the prebuilt @marcel/ink bundle and inline the source instead:
  ...
  alias: { '@marcel/ink': resolve(root, 'packages/marcel-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The marcel_cli launcher
