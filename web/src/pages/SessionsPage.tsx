...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    marcel_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__marcel_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id, rowProfile(id)), {
          ...
          headers: {
            "X-Marcel-Session-Token":
              (window as unknown as { __MARCEL_SESSION_TOKEN__?: string })
                .__MARCEL_SESSION_TOKEN__ ?? "",
          },
        });
