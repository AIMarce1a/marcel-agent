...
const STORAGE_KEY = "marcel-dashboard-theme";
...
const FONT_STORAGE_KEY = "marcel-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `marcel_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "marcel-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-marcel-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-marcel-theme-font", "true");
