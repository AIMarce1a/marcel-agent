 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `marcel_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Marcel Teal",
  description: "Classic dark teal — the canonical Marcel look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Marcel Teal (Large)",
  description: "Marcel Teal with bigger fonts and roomier spacing",
