...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateMarcel: string;
    updateMarcelConfirmMessage?: string;
    updateMarcelConfirmNow?: string;
    updateMarcelConfirmTitle?: string;
    updatingMarcel: string;
  ...
  // ── Achievements plugin (plugins/marcel-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
