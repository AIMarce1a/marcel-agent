 ...
 *
 * Values mirror marcel_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Marcel default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Marcel' default when unset). */
