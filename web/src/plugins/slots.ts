 ...
 * `window.__MARCEL_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Marcel brand in the top bar
 ...
 *  `window.__MARCEL_PLUGINS__.registerSlot(...)`.
 *
