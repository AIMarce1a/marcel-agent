/**
 * Marcel Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__MARCEL_PLUGIN_SDK__`` and
 * ``window.__MARCEL_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__MARCEL_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``MarcelPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@marcel/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__MARCEL_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__MARCEL_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__MARCEL_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface MarcelPluginSDK {
...
declare global {
  interface Window {
    __MARCEL_PLUGIN_SDK__?: MarcelPluginSDK;
    __MARCEL_PLUGINS__?: PluginRegistry;
  }
}
