 ...
 *
 * Plugins call window.__MARCEL_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__MARCEL_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__MARCEL_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__MARCEL_PLUGIN_SDK__ = {
    ...
    // window.__MARCEL_SESSION_TOKEN__ directly.
    authedFetch,
