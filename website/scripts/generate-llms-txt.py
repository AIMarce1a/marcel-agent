#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Marcel docs site.
...
LLM reads to learn what Marcel does.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Marcel as a Python Library", None),
        ("guides/use-mcp-with-marcel", "Use MCP with Marcel", None),
        ("guides/use-voice-mode-with-marcel", "Use Voice Mode with Marcel", None),
        ("guides/use-soul-with-marcel", "Use SOUL.md with Marcel", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Marcel"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "marcel-agent/main/scripts/install.sh | bash`  "
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Marcel Agent — Full Documentation\n",
        (
            "This file is the entire Marcel Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Marcel, Features, Messaging, Integrations, Guides, "
