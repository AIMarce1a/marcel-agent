...
description: "How the Marcel Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Marcel Desktop app connects to a **gated gateway** (a hosted or
...
For Marcel specifically, native sign-in means:
...
- [Run Marcel with Nous Portal](./run-marcel-with-nous-portal.md)
