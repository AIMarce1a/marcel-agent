...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `marcel_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `marcel_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Marcel Plugin](plugins/index.md) |
...
| Session storage | `marcel_state.py`, `marcel_state_*.py` | [Session Storage](session-storage.md) |
