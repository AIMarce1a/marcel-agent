...
| | |
|---|---|
| Source | Optional — install with `marcel skills install official/web-development/page-agent` |
...
- User wants **Marcel itself to drive a browser** → use Marcel' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
