...
| | |
|---|---|
| Source | Optional — install with `marcel skills install official/finance/stocks` |
| Path | `optional-skills/finance\stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Marcel Agent |
| License | MIT |
...
```
SCRIPT=~/.marcel/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.marcel/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
