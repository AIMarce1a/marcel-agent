...
| | |
|---|---|
| Source | Optional — install with `marcel skills install official/creative/impeccable` |
...
> ships and verifies a Marcel-native skill bundle under `.marcel/skills/`.
> `marcel skills install impeccable` pulls the current bundle live from that
