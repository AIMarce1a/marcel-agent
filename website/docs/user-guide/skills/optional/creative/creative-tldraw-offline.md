...
| | |
|---|---|
| Source | Optional — install with `marcel skills install official/creative/tldraw-offline` |
| Path | `optional-skills/creative\tldraw-offline` |
| Version | `1.0.0` |
| Author | Teknium + Marcel Agent |
| License | MIT |
...
- **Agent skills installed in the app**: `Develop → Install Agent Skills`. The
  ...
  recipes below. (This Marcel skill mirrors that guidance for Marcel.)
