...
| | |
|---|---|
| Source | Optional — install with `marcel skills install official/creative/ascii-art` |
| Path | `optional-skills/creative\ascii-art` |
| Version | `4.0.0` |
| Author | 0xbyt4, Marcel Agent |
| License | MIT |
...
```bash
python -m pyfiglet "MARCEL" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=MARCEL&font=Slant" | boxes -d stone
```
