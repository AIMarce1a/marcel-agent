...
| | |
|---|---|
| Source | Optional — install with `marcel skills install official/research/blogwatcher` |
...
## Working with Marcel tools (read this first)

`blogwatcher-cli` is the feed database; Marcel tools do the automation around it:
