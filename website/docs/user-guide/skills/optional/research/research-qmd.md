...
| | |
|---|---|
| Source | Optional — install with `marcel skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`marcel-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-marcel-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Marcel Agent via the native MCP client. This is the preferred
...
Then configure Marcel Agent to connect via HTTP:
