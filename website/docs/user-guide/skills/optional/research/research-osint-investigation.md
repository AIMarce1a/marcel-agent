...
| | |
|---|---|
| Source | Optional — install with `marcel skills install official/research/osint-investigation` |
| Path | `optional-skills/research\osint-investigation` |
| Version | `0.1.0` |
| Author | Marcel Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $MARCEL_OSINT_CACHE/icij/ (default: ~/.cache/marcel-osint/icij/).
...
# Set MARCEL_OSINT_UA=your-app/1.0 (your@email) to identify yourself
