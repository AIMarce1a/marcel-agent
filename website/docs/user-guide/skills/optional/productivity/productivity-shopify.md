...
| | |
|---|---|
| Source | Optional — install with `marcel skills install official/productivity/shopify` |
...
4. Save to `${MARCEL_HOME:-~/.marcel}/.env`:
   ```
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Marcel","productType":"Apparel","tags":["test"]}}'
```
