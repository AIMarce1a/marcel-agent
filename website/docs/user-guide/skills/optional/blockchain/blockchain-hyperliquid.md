...
| | |
|---|---|
| Source | Optional — install with `marcel skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain\hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Marcel Agent |
| License | MIT |
...
The script reads `${MARCEL_HOME:-~/.marcel}/.env` for two optional defaults:
...
Helper script: `~/.marcel/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ~/.marcel/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${MARCEL_HOME:-~/.marcel}/.env`.
...
```bash
python ~/.marcel/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.marcel/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
