...
| | |
|---|---|
| Source | Optional — install with `marcel skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain\solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Marcel Agent |
| License | MIT |
...
Helper script path: ~/.marcel/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.marcel/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.marcel/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.marcel/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.marcel/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.marcel/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.marcel/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
