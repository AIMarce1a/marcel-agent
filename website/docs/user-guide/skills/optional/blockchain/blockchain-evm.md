...
| | |
|---|---|
| Source | Optional — install with `marcel skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain\evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Marcel Agent |
| License | MIT |
...
Helper script path: `~/.marcel/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.marcel/skills/blockchain/evm/scripts/evm_client.py
...
python ~/.marcel/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.marcel/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
