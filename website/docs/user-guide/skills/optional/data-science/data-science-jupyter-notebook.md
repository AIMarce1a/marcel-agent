...
| | |
|---|---|
| Source | Optional — install with `marcel skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing marcel tool access (web_search, file ops). Stateless. |
