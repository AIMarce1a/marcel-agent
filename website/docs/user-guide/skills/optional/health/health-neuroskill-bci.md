...
| | |
|---|---|
| Source | Optional — install with `marcel skills install official/health/neuroskill-bci` |
...
Connect Marcel to a running [NeuroSkill](https://neuroskill.com/) instance to read
