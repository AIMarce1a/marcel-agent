...
| [`marcel-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-marcel-agent) | Use, configure, theme, extend, and orchestrate Marcel Agent. | `autonomous-ai-agents\marcel-agent` |
...
| [`marcel-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-marcel-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development\marcel-agent-skill-authoring` |
| [`inspecting-marcel-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-marcel-desktop-dom) | Read the live Marcel desktop DOM/CSS over CDP. | `software-development\inspecting-marcel-desktop-dom` |
