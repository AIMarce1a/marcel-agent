...
slug: /
sidebar_position: 0
title: "Marcel Agent Documentation"
...
After installing, run `marcel setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::

## What is Marcel Agent?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Marcel safely  |
| 🧭 **[Use MCP with Marcel](/guides/use-mcp-with-marcel)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Marcel](/guides/use-voice-mode-with-marcel)** | Hands-on setup and usage patterns for Marcel voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Marcel' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Marcel                              |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind Marcel, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind Marcel, Nomos, and Psyche models

## For LLMs and coding agents

Machine-readable entry points to this documentation:

- **[`/llms.txt`](https://marcel-agent.com/llms.txt)** — curated index of every doc page with short descriptions. ~17 KB, safe to load into an LLM context.
- **[`/llms-full.txt`](https://marcel-agent.com/llms-full.txt)** — every doc page concatenated into a single markdown file for one-shot ingestion. ~1.8 MB.
