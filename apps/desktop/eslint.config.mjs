...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @marcel/plugin-sdk (+ react), never `@/…`
      ...
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@marcel/shared'],
              message: 'Plugins import only @marcel/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
