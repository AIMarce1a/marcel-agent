import type { MarcelReviewFile } from '@/global'
...
export function buildReviewFlatList(files: MarcelReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: MarcelReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
