...
const TAKEOVER_KEY = 'marcel.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Marcel can't clear via the API — the user
 *  sees exactly what runs instead of Marcel silently deleting their creds. */
