...
import { getActionStatus, getComputerUseStatus, grantComputerUsePermissions } from '@/marcel'
import { upsertDesktopActionTask } from '@/store/activity'
import { notify, notifyError } from '@/store/notifications'
import type { ComputerUseStatus } from '@/types/marcel'
 ...
 * cua-driver's own `com.trycua.driver` identity — not Marcel — and are
        ...
        <div className="min-w-0">
          {status.can_grant ? (
            <p className="text-[0.72rem] text-muted-foreground">
              Grants attach to CuaDriver&apos;s own identity (com.trycua.driver), not Marcel — so the dialog is
