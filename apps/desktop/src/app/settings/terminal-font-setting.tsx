...
import { setMarcelConfigCache, useMarcelConfigRecord } from '../hooks/use-config-record'
...
function fontFamilyFromConfig(config: MarcelConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useMarcelConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<MarcelConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setMarcelConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="marcel-terminal-font-families"
          ...
          <datalist id="marcel-terminal-font-families">
