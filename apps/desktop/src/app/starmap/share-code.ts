...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/marcel'
...
const VERSION = 3
const PREFIX = 'HML' // "Marcel Memory Loadout" — namespaces our codes like WoW's leading bytes.
