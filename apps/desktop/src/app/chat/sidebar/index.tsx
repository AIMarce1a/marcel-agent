...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/marcel'
...
// highlight markers (sqlite snippet() delimiters — see marcel_state_search.py).
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('marcel:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('marcel:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Marcel to
