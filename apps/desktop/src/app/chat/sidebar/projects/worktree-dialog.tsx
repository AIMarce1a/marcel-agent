...
import type { MarcelGitBranch } from '@/global'
...
const branchActionLabel = (branch: MarcelGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<MarcelGitBranch[]>([])
  ...
  const convert = async (branch: MarcelGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
