...
const FOCUS_EVENT = 'marcel:composer-focus'
const INSERT_EVENT = 'marcel:composer-insert'
const ATTACH_IMAGES_EVENT = 'marcel:composer-attach-images'
const INSERT_REFS_EVENT = 'marcel:composer-insert-refs'
const SUBMIT_EVENT = 'marcel:composer-submit'
const VOICE_TOGGLE_EVENT = 'marcel:composer-voice-toggle'
const MODEL_MENU_EVENT = 'marcel:composer-model-menu'
