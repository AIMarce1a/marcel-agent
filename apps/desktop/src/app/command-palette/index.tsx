...
import { getMarcelConfigRecord, listAllProfileSessions } from '@/marcel'
...
// Marcel session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-marcel',
            keywords: ['update', 'upgrade', 'marcel', 'version', 'system', 'restart'],
            label: cc.updateMarcel,
