...
import type * as MarcelApi from '@/marcel'
...
vi.mock('@/marcel', async importOriginal => ({
  ...(await importOriginal<typeof MarcelApi>()),
...
describe('SkillsView toolset management', { timeout: 60_000 }, () => {
    ...
    await act(async () => {
      window.dispatchEvent(
        new MessageEvent('message', {
          data: { type: 'marcel-skill-pick', name: 'web-research', identifier: 'web-research' },
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { marcelDesktop?: unknown }).marcelDesktop = { connections, getAgentRoster }
