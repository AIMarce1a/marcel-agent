...
import { getLatestSessionMessages, type ProfileScope } from '@/marcel'
...
interface BackgroundSyncParams {
  ...
  refreshMarcelConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshMarcelConfig])
}
