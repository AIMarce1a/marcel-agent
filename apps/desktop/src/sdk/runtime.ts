 ...
 * plugins resolve `@marcel/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __MARCEL_PLUGIN_SDK__: sdk,
  __MARCEL_REACT__: React,
  __MARCEL_REACT_JSX__: jsxRuntime,
  __MARCEL_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@marcel/plugin-sdk': shimUrl('__MARCEL_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__MARCEL_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__MARCEL_REACT_JSX__'),
    react: shimUrl('__MARCEL_REACT__')
  }
