...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshMarcelPathTitle: string
      sshMarcelPathDesc: string
      sshMarcelPathPlaceholder: string
  ...
  commandCenter: {
    ...
    marcelActiveSessions: (version: string, count: number) => string
