...
export const en: Translations = {
  ...
  boot: {
    ready: 'Marcel Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Marcel settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Marcel backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingMarcelDesktop: 'Starting Marcel Desktop…'
    },
    errors: {
      backgroundExited: 'Marcel background process exited.',
      backgroundExitedDuringStartup: 'Marcel background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Marcel backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateMarcel: 'Update Marcel',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Marcel Desktop.',
    ...
    native: {
      ...
      inputBody: 'Marcel is waiting for your response.',
      turnDoneTitle: 'Marcel finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `marcel debug share --nous` from a terminal, or `marcel debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Marcel defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Marcel backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Marcel backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.marcel/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Marcel is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Marcel asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Marcel was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Marcel was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Marcel follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Marcel can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Marcel when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Marcel walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Marcel is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Marcel, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Marcel Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Marcel runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Marcel only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Marcel',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Marcel checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Marcel configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Marcel.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Marcel gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Marcel Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Marcel Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Marcel runtime managed by this app.',
      kindRemoteDesc: 'A Marcel gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Marcel Cloud account.',
      kindSshDesc: 'A Marcel install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Marcel manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Marcel Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Marcel backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset MARCEL_DESKTOP_REMOTE_URL and MARCEL_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Marcel backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Marcel backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Marcel Cloud',
      cloudDesc: 'Sign in once to Marcel Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Marcel Cloud',
      cloudSignIn: 'Sign in to Marcel Cloud',
      cloudSignedIn: 'Signed in to Marcel Cloud',
      cloudNeedsSignIn: 'Sign in to Marcel Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Marcel Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Marcel Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Marcel Cloud',
      cloudSignedOutMessage: 'Cleared the Marcel Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /marcel.',
      ...
      restartingMessage: 'Marcel Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Marcel ${version}` : ''}`,
      ...
      sshDesc:
        'Marcel is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshMarcelPathTitle: 'Marcel path (optional)',
      sshMarcelPathDesc: 'Full path to the remote marcel binary. Blank = auto-detect.',
      sshMarcelPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Marcel found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Marcel runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Marcel is not installed on the remote host. Install it there (curl -fsSL https://raw.githubusercontent.com/AdMind-ai/marcel-agent/main/scripts/install.sh | sh) or set the Marcel path.',
      sshErrPlatform:
        'Unsupported remote platform. Marcel Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Marcel on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Marcel. Review the exact configuration below — it comes from the link, not from Marcel.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Marcel starts and manages the server for you.`,
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build Marcel ships.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Marcel runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Marcel at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Marcel browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via marcel curator restore.',
  ...
  starmap: {
    ...
    emptyDesc: 'As Marcel builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Marcel to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Marcel to generate pets.',
      backgroundHint: 'You can close this — Marcel will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Marcel desktop' },
    ...
    marcelActiveSessions: (version, count) => `Marcel ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@marcel:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Marcel you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://marcel.example.com',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Marcel environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Marcel did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Marcel will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Marcel backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Marcel. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Marcel backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Marcel...',
    placeholderReconnecting: 'Reconnecting to Marcel…',
    ...
    attachUrlDesc: 'Marcel will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Marcel to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Marcel…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Marcel…',
    ...
    unsupportedMessage: 'This version of Marcel can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Marcel from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Marcel will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Marcel desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Marcel updater takes over in its own window and reopens Marcel automatically when it’s done. Please don’t reopen Marcel yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Marcel reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Marcel reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Marcel?',
    blockerBody:
      'Marcel needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Marcel',
    foreignBlockerBody:
      'Marcel can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Marcel can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Marcel needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Marcel Desktop',
    setupChoiceDesc:
      'Connect this app to a Marcel gateway you already run, or install Marcel locally on this computer.',
    connectExistingTitle: 'Connect to existing Marcel',
    ...
    installLocalTitle: 'Install Marcel locally',
    installLocalDesc: 'Download Marcel, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Marcel Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Marcel',
    remoteSetupDesc: 'Enter your gateway URL. Marcel Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Marcel gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/marcel',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Marcel gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Marcel Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Marcel CLI or desktop instance is running. Stop any running Marcel instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Marcel Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Marcel is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Marcel…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Marcel',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Marcel at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Marcel connects automatically',
    ...
    authorizeThere: 'Authorize Marcel there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Marcel there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Marcel Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Marcel Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Marcel will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Marcel is restarting...',
      askRestart: 'Ask Marcel to restart the server',
      lookingRestart: taskId => `Marcel is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Marcel is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Marcel to open a page.',
      finishedRestarting: message => `Marcel finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Marcel could not restart the server.',
      stillWorking:
        'Marcel is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Marcel is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Marcel gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.marcel/config.yaml). Marcel won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Marcel needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Marcel needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Marcel Desktop to use Save Image.',
    restartToSaveImages: 'Restart Marcel Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `marcel gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Marcel loads when the work calls for them.'
      },
      messaging: {
        title: 'Marcel away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Marcel made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Marcel — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
