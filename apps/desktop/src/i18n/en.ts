...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        'Marcel is not installed on the remote host. Install it there (curl -fsSL https://raw.githubusercontent.com/AIMarce1a/marcel-agent/main/scripts/install.sh | sh) or set the Marcel path.',
      sshErrPlatform:
