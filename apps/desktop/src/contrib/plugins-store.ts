 ...
 * `<marcel home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'marcel.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'marcel.desktop.disabledPlugins.v1'
