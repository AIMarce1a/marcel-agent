...
const STORAGE_KEY = 'marcel.desktop.layoutTree.v2'

writeKey('marcel.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('marcel.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('marcel.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'marcel.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'marcel.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'marcel.desktop.hiddenStripTabs.v1'
...
writeKey('marcel.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__MARCEL_LAYOUT_TREE__ = {
    close: closeTreePane,
