...
export const MARCEL_CONTEXT_MENU_TRIGGER_ATTR = 'data-marcel-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-marcel-context-menu-trigger="" />
  )
}
