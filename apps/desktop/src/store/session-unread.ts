...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('marcel.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('marcel.desktop.unreadFinishedSessions')
