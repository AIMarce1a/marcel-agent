...
function installBridge(
  openSessionWindow?: Window['marcelDesktop']['openSessionWindow'],
  openWindow?: Window['marcelDesktop']['openWindow'],
  openBrowserWindow?: Window['marcelDesktop']['openBrowserWindow']
) {
