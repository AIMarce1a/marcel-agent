...
export interface PetInfo {
  ...
  // the Marcel "run" activity state uses the in-place running row).
 ...
 * MARCEL_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'marcel.desktop.pet-roam.v1'
