...
const POPOUT_STORAGE_KEY = 'marcel.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'marcel.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'marcel.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'marcel.desktop.composerPopout.position'
