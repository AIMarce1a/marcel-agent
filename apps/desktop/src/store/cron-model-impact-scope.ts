...
function identityForConnection(connection: MarcelConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: MarcelConnection | null): void {
