...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://marcel.example.com:8443/x')).toBe('marcel.example.com:8443')
    expect(remoteHostLabel('https://marcel.example.com:443')).toBe('marcel.example.com')
    expect(remoteHostLabel('http://marcel.example.com:80')).toBe('marcel.example.com')
  })
