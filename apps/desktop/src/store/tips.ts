 ...
 * - It covers Marcel too. "Off" from someone who has just closed a bubble means
...
const ENABLED_KEY = 'marcel.desktop.tips.rotation.v1'

export const $tipsEnabled = persistentAtom(ENABLED_KEY, true, Codecs.bool)
export const $retiredTips = persistentAtom<string[]>('marcel.desktop.tips.retired.v1', [], Codecs.stringArray)
export const $lastTipId = persistentAtom<null | string>('marcel.desktop.tips.last.v1', null, Codecs.nullableText)
export const $nextTipAt = persistentAtom<null | number>(
  'marcel.desktop.tips.next.v1',
  null,
...
export const $tipShownAt = persistentAtom<Record<string, number>>(
  'marcel.desktop.tips.shownAt.v1',
  {},
  Codecs.json(value => {
