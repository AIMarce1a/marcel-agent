...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/marcel-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'marcel_cli/config_defaults.py'), 'utf8')
