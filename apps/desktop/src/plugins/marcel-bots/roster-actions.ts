...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@marcel/plugin-sdk'
 ...
 *  (marcel-agent#90102) and are discarded. Without `canonical_session` (older
