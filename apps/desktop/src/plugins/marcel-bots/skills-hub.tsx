...
import { Button, host, Input } from '@marcel/plugin-sdk'
...
// {type: 'marcel-skill-pick', ...} to us (marcel-agent#86243). We validate
...
export function HubSkillsSection({ forProfile, onInstalled }: HubSkillsSectionProps) {
  ...
  useEffect(() => {
    ...
    const onMessage = (event: MessageEvent) => {
      ...
      if (!data || data.type !== 'marcel-skill-pick' || !data.name) {
        return
      }
