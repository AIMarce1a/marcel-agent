...
import type { MarcelPlugin, PaletteContribution } from '@marcel/plugin-sdk'
import { $accentOverride, PALETTE_AREA, setAccentOverride, STATUSBAR_AREAS } from '@marcel/plugin-sdk'

import { AccentPickerTrigger } from './picker'

const plugin: MarcelPlugin = {
  id: 'accent',
  name: 'Accent Picker',
  description:
