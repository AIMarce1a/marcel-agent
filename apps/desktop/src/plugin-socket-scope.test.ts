...
// (#73044). Exercises the REAL marcel + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/marcel')
...
const conn = (over: Partial<MarcelConnection> = {}): MarcelConnection =>
  ({
    authMode: 'oauth',
