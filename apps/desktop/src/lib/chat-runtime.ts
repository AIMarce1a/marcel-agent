...
import type { ModelOptionsResponse, SessionInfo } from '@/types/marcel'
 ...
 *
 * Only the leading status prefix (e.g. "Marcel is thinking...") and the
 ...
 *  resolved comment as JSON (MarcelPrComment shape); a malformed payload falls
