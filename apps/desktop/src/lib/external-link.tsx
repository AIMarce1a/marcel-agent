...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|marcel):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.marcelDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.marcelDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Marcel, and it is the surface the agent
