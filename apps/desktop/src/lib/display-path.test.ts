...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/marcel-agent')).toBe('~/www/marcel-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/marcel-agent')).toBe('marcel-agent')
    expect(pathLeaf('~/www/marcel-agent')).toBe('marcel-agent')
