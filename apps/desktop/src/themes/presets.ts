...
/**
 * Nous — the canonical Marcel desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Marcel's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Marcel desktop identity: GitHub's chrome carrying Nous
