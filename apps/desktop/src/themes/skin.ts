/**
 * Marcel skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$MARCEL_HOME/skins/` (or a
 * built-in) resolved by `marcel_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Marcel authors from a prompt lights up all three surfaces from one file.
 *
...
import type { MarcelSkin, SkinColors } from '@marcel/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: MarcelSkin): DesktopTheme | null {
