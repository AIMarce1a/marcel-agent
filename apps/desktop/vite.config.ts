...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\marcel\marcel-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@marcel/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@marcel/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@marcel/shared': path.resolve(__dirname, '../shared/src'),
