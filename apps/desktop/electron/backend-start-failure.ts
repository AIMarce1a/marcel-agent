 ...
 * startMarcel() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startMarcel() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startMarcel`, re-emits
