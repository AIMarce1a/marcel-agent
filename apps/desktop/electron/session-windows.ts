...
// by main.ts (`setBackgroundThrottling` driven by the merged `marcel:active-work`
...
// (the "Marcel idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Marcel" wake word has NO preceding click,
