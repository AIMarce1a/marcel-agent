...
// even though a fresh shell — and the Marcel CLI — sees it immediately. The
// desktop's MARCEL_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\marcel. Reading
...
//       MARCEL_HOME    REG_SZ    F:\Marcel\data
//
