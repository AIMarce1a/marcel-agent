...
cd apps/desktop
XCURSOR_SIZE=24 MARCEL_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/marcel-typing
# → /tmp/marcel-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/marcel-typing.before.heapsnapshot
# → /tmp/marcel-typing.after.heapsnapshot
```
