/**
 * Canonical Marcel skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$MARCEL_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`marcel_cli/skin_engine.py`),
 ...
 *   • CLI     → `marcel_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
